...
# Added import for anti_objection_system
...
def analyze():
    ...
    try:
        ...
        # Sistema anti-objeção já é executado pelo super_orchestrator
        # Não é necessário executar novamente aqui
...
@analysis_bp.route('/api/sessions/<session_id>/progress', methods=['GET'])
